...
export const MODULE_CATALOG: ModuleCatalogItem[] = [
  ...
  { id: 'finance', name: 'Finance', description: 'Financial management', icon: 'cash', resource: 'MODULE_FINANCE', enabled: true, target: { tab: 'Modules', screen: 'FinanceHome' } },
  ...
  { id: 'hr', name: 'HR & Personnel', description: 'Human resources management', icon: 'person-add', resource: 'MODULE_HR', enabled: true, target: { tab: 'Modules', screen: 'HrHome' } },
  ...
  { id: 'ai', name: 'AI Intelligence', description: 'AI-powered insights', icon: 'sparkles', resource: 'MODULE_AI', enabled: true, target: { tab: 'Modules', screen: 'AiHome' } },
