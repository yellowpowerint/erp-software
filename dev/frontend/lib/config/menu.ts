...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'fleet-maintenance-schedules',
        label: 'Maintenance Schedules',
        icon: Calendar,
        path: '/fleet/maintenance/schedules',
        roles: [
          UserRole.SUPER_ADMIN,
          UserRole.CEO,
          UserRole.CFO,
      ...
      {
        id: 'fleet-maintenance-calendar',
        label: 'Maintenance Calendar',
        icon: Calendar,
        path: '/fleet/maintenance/calendar',
        roles: [
          UserRole.SUPER_ADMIN,
          UserRole.CEO,
          UserRole.CFO,
      ...
      {
        id: 'fleet-fuel-record',
        label: 'Record Fuel',
        icon: Fuel,
        path: '/fleet/fuel/record',
        roles: [
          UserRole.SUPER_ADMIN,
          UserRole.CEO,
          UserRole.CFO,
      ...
      {
        id: 'fleet-fuel-reports',
        label: 'Fuel Reports',
        icon: Fuel,
        path: '/fleet/fuel/reports',
        roles: [
          UserRole.SUPER_ADMIN,
          UserRole.CEO,
          UserRole.CFO,
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'procurement-invoices-pending',
        label: 'Invoices Pending Match',
        icon: FileText,
        path: '/procurement/invoices/pending',
        roles: [
          UserRole.SUPER_ADMIN,
          UserRole.CEO,
          UserRole.CFO,
      ...
      {
        id: 'procurement-payments-due',
        label: 'Due Payments',
        icon: AlertTriangle,
        path: '/procurement/payments/due',
        roles: [
          UserRole.SUPER_ADMIN,
          UserRole.CEO,
          UserRole.CFO,
