...
DO $$
BEGIN
  ALTER TABLE "csv_audit_logs" ADD CONSTRAINT "csv_audit_logs_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
EXCEPTION
...
DO $$
BEGIN
  ALTER TABLE "csv_batches" ADD CONSTRAINT "csv_batches_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;
...
DO $$
BEGIN
  ALTER TABLE "import_rollbacks" ADD CONSTRAINT "import_rollbacks_importJobId_fkey" FOREIGN KEY ("importJobId") REFERENCES "import_jobs"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;
...
DO $$
BEGIN
  ALTER TABLE "import_changes" ADD CONSTRAINT "import_changes_rollbackId_fkey" FOREIGN KEY ("rollbackId") REFERENCES "import_rollbacks"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;
...
DO $$
BEGIN
  ALTER TABLE "scheduled_exports" ADD CONSTRAINT "scheduled_exports_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;
...
DO $$
BEGIN
  ALTER TABLE "scheduled_export_runs" ADD CONSTRAINT "scheduled_export_runs_scheduledExportId_fkey" FOREIGN KEY ("scheduledExportId") REFERENCES "scheduled_exports"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;
...
DO $$
BEGIN
  ALTER TABLE "scheduled_export_runs" ADD CONSTRAINT "scheduled_export_runs_exportJobId_fkey" FOREIGN KEY ("exportJobId") REFERENCES "export_jobs"("id") ON DELETE SET NULL ON UPDATE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;
