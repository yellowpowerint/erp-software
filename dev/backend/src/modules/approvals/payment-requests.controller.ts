...
export class PaymentRequestsController {
  ...
  createPaymentRequest(@CurrentUser() user: any, @Body() dto: CreatePaymentRequestDto) {
    return this.paymentRequestsService.createPaymentRequest(user.userId, dto);
  }

  @Get()
  getPaymentRequests(@CurrentUser() user: any) {
    return this.paymentRequestsService.getPaymentRequests(user.userId, user.role);
  }
  ...
  approvePaymentRequest(
    ...
    return this.paymentRequestsService.approvePaymentRequest(id, user.userId, user.role, dto);
  }
  ...
  rejectPaymentRequest(
    ...
    return this.paymentRequestsService.rejectPaymentRequest(id, user.userId, user.role, dto);
  }
}
