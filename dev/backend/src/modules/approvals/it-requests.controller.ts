...
export class ITRequestsController {
  ...
  @Post()
  @Roles('SUPER_ADMIN', 'CEO', 'CFO', 'IT_MANAGER', 'DEPARTMENT_HEAD', 'OPERATIONS_MANAGER')
  ...
  approveITRequest(
    ...
    return this.itRequestsService.approveITRequest(id, user.userId, user.role, dto);
  }
  ...
  rejectITRequest(
    ...
    return this.itRequestsService.rejectITRequest(id, user.userId, user.role, dto);
  }
}
